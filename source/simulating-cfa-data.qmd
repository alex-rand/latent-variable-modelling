...
And in classic ordinal variable modelling fashion, we can just use subtraction to get the level-speccific probabilities (we already got the probability of level 1 for free above):
