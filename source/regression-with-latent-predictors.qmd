...
#| message: false
#| warning: false
#| fig-cap: "A Bayesian win: posterior estimates for regression coefficients of latent predictors (blue densities) are more precise than estimates from the traditional two-stage approach using factor score point estimates (grey point-ranges)."
...
ggplot() +
  ...
  scale_colour_manual(
    ...
    values=c('Non-truncated posterior draws' = alpha(clrs$blue, .4), 
