...
fake_dat <- lavaan::simulateData(model = lavaan.model, sample.nobs = 4000)
...
# Add the latent variables to the dataset as all NA columns
...
bfit.1 <- brm(
    ...
    family = gaussian(),
    prior =
      prior(normal(0, 10), class = "b", resp = "m1") +
      ...
      prior(constant(0), class = "Intercept", resp = "f1") +
      prior(constant(1), class = "sigma", resp = "f1"),
      prior(constant(0), class = "Intercept", resp = "f2") +
      prior(constant(1), class = "sigma", resp = "f2"),
    data = fake_dat,
    warmup = 1000,
    iter = 6000,
