...
fake_dat |>
  ...
  theme_bw() +  # Use the minimal theme as a starting point, which removes some gridlines
  theme(
...
tidy_results |>
  ...
  geom_hline(aes(yintercept = true_effect), linetype = 2) + 
...
- Add rejection sampling to deal with the overdispersion we encountered in the previous moddel, as shown in https://ermeel86.github.io/case_studies/surv_stan_example.html)
