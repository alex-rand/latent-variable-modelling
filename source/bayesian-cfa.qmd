...
# Save the resulting model fit
saveRDS(fit, "source/fits/b07.04.informative.priors.rds")
...
# Save the result
saveRDS(draws, "source/fits/b07.04.rds")
...
draws |>
 ...
 # mutate(estimate = exp(estimate)) |>
  ...
  mutate(true_loading = case_when(
    ...
    .variable == "Loading for m2" ~ .6,
    .variable == "Loading for m3" ~ .9,
    .variable == "Loading for m4" ~ .9,
    .variable == "Loading for m5" ~ .7,
    .variable == "Loading for m6" ~ .8,
    .variable == "Covariance for f1 ~ f2" ~ .4,
    .variable == "Covariance for m1 ~ m4" ~ .4
  )) |>
