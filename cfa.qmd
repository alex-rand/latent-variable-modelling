...
To my eye it looks like some of the standardized loadings on the 'mav' factor are pretty low. Also, it seems like only really 'pap' has really consistent loadings across all of its measured variables: the other three factors all have a bunch of variance between their loadings. So this all seems like a bit of a red flag.
