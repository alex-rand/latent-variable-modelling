...
Next I notice that the factor loadings and residual variances look pretty good and consistent across the groups. This is suggestive of what people unfortunately like to call **Configural Invariance**, which just means the model fits to the groups pretty much the same in isolation. The main exception I notice is that there's a bunch more residual variance in 'math' for boys than for girls. So maybe that's something to look out for.
...
## Example 5: Something Longitudinal
