...
Now notice that, besides these first fixed loadings, all of the loadings are highly statistically significant, with all p-values smaller than .01. This is good! Super statistically-significant loadings are a necessary sign that our factor model is a good fit. But it is not sufficient.

All-in-all, this provides fine evidence of convergent validity because the loadings are all significant and positive?

### Factor Loadings and Discriminant Validity
