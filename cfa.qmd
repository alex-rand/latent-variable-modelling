...
So here's the archetypal DAG of a CFA, where the Xs are observed variables, and F1 is an unmeasured variable I am imagining to exist.
...
## Example 5: Longitudinal Measurement Invariance {.unnumbered}

Also do a longitudinal measurement invariance model, since this is what OLES is. Maybe simulate it?

## Example 6: Multilevel CFA {.unnumbered}

Brown has an example

## Example 7: Going Bayesian? {.unnumbered}
