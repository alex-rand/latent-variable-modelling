...
Do the measurement invariance example from here: https://stats.oarc.ucla.edu/r/seminars/lgm/#s2a

Also do a longitudinal measurement invariance model. Maybe simulate it? Load the data:
