...
# Look at the results
h1.summary <- summary(h1.fit, fit.measures = TRUE)
...
Now notice that, besides these first fixed loadings, all of the loadings are highly statistically significant, with all p-values smaller than .01. This is good! Super statistically-significant loadings are a necessary sign that our factor model is a good fit. But it is not sufficient, so these p-values are not super informative.

Next let's look at the estimated correlations between the factors.
