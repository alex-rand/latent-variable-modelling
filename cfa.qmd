...
This is exactly what @Green-et-al-1993 did. They collected 4 columns each for 'happy' and 'sad', with each column having a different measurement approach.

But wait -- what about the confounding due to shared measurement approach! We should control for that, either by adding some measurement approach factors, or by freeing-up the relevant residual covariance parameters in the likelihood.
...
Let's go ahead and fit an example of each of these types of model:

....

Getting on to MTMM...I think the idea is t
